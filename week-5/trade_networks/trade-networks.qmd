...
For a given directed network, reciprocity is the probability of having links in both directions between two vertices.

Rec. measures how the economies of two countries become interconnected (or interdependent).
...
The export matrix $M$ is an adjacency matrix which represents a bipartite graph.
