...
- correlations in time series (or simply *co-movements*) are valuable indicators
...
- however, monitoring $n(n-1)$ correlations quickly becomes unfeasible 
...
*Prune* it to create its Minimum Spanning Tree (MST)

The MST has only n-1 *heavy* connections while maintaining connectivity.


[![](./imgs/mst-example.png){width=30%}](https://en.wikipedia.org/wiki/Minimum_spanning_tree)
...
- Network analysis helps identifying local clusters
