...
format:
  revealjs: 
    ...
    scrollable: true
    # auto-stretch: false
    # mermaid is called by Quarto but wants an object
    mermaid: # {}
    # for the {mermaid} version  
      fontSize: 16
      flowchart:
        nodeSpacing: 50
        rankSpacing: 50
...
![](./imgs/provost-cover.jpg){.nostretch fig-align="center" width="25%"}
...
__Measure:__ misclassification of datapoints in $\mathbf{D}$
...
![](./imgs/false_positives_and_negatives.jpg){width="30%"}

-----

## Misclassification: multi-class 

![](./imgs/misclass-examples.png){width="80%"}


-----

![](./imgs/misclassification.png){width="60%"}
...
[PF] "classification predicts whether something will happen, whereas regression predicts how much something will happen."
...
detect similarities of objects on the basis on their appearing together in transactions.
...
Example: [Social media profiling](https://ieeexplore.ieee.org/abstract/document/6994286) 
...
Clarity about the problem allows clarity about the algorithm.

![](./imgs/the_triad.png){width="20%"}
...
The a. may 'memorise' past solutions and re-apply them, via some similarity criterion.

Advanced a. may 'learn' a model and apply it to future inputs. 
...
* obtain a dataset of *labeled* examples: the class assignment or the value are known; 

* split it in training and test data;

* run a. on the test data, find a putative solution, and
