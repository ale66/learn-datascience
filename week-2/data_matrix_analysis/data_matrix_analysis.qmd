...
![](./imgs/anticlockwise.png){width="80%"}
...
$$\lambda_1 = i, \mathbf{e_1} = [1, -i]^T$$

$$\lambda_2 = -i, \mathbf{e_2} = [1, i]^T$$
...
Stretching ($Q^{-1}$), followed by rotation ($\Lambda$) followed by 'stretching back' (Q)
